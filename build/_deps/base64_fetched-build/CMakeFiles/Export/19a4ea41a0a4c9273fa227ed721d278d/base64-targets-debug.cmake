...
set_target_properties(aklomp::base64 PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libbase64.a"
  )
...
# Import target "aklomp::base64-bin" for configuration "Debug"
set_property(TARGET aklomp::base64-bin APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(aklomp::base64-bin PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/base64"
  )
